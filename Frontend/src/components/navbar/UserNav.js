...
const UserNav = () => {
    ...
    return (
        <div>
                ...
                {isMobileNavOpen && (
                    ...
                    >
                        <div className="flex justify-between items-center p-3">
                            ...
                            <button onClick={toggleMobileNav} className="text-white text-3xl">X</button>
                        </div>
            ...
            {/* Sidebar for Desktop */}
            <div
                className={`hidden md:flex ${isCollapsed ? 'w-16' : 'w-64'} bg-gray-800 text-white h-screen fixed flex-col transition-width duration-300`}
            >
                {/* Toggle and Logo Section */}
                <div className="flex items-center space-x-32 p-3">
                    {!isCollapsed && (
